    ...
    return {
        ...
        "caldaia_legna": {
            ...
            "module_summaries": {
                ...
                "resistenze_volano": "Regola: base Export se Export>Possibile o se resistenze ON da Export; altrimenti Possibile. Export + resistenze. Sotto soglia ON step-down; Export <= 0W o batteria scarica hard-OFF.",
